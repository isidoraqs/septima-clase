...
function draw() {
   ...
   var total_primera = 216;
   var total_segunda = 184;
   var total_tercera = 491;
   var muertos_primera = 80;
   var muertos_segunda = 97;
   var muertos_tercera = 372;
   //con esto cuento el total de pasajeros por clase
   for (var a = 0; a < data.getRowCount(); a++) {
      if (data.get(a, 2) == 1) {
         total_primera++
      } else if (data.get(b, 2) == 2) {
         total_segunda++
      } else if (data.get(c, 2) == 3) {
         total_tercera++
      }
   }
 ...
 for (var b = 0; b < data.getRowCount(); b++) {
    if ((data.get(c, 1) == 0) && (data.get(c, 2) == 3)) {
       muertos_tercera++
   ...
   for (var c = 0; b < data.getRowCount(); c++) {
      if ((data.get(c, 1) == 0) && (data.get(c, 2) == 3)) {
         muerto++
